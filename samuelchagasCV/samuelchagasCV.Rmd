...
tribble(
  ...
  c("Worked as a freelancer on clinical data projects, performing ETL, cohort generation, data visualization, clinical study reports, and statistical analyses.", "\\textbf{|} R \\textbf{|} SparkR \\textbf{|} RMarkdown \\textbf{|} Cloud/N3C \\textbf{|}")
) %>% 
  detailed_entries(Position, Year, Institution, Where, Why, .protect = FALSE)
```
